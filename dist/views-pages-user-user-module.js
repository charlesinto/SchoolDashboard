...
module.exports = ".mat-form-field {\n  width: 100%; }\n\n.mat-button-base {\n  width: 100%; }\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
/* harmony import */ var _core_auth_services_auth_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../../../core/auth/_services/auth.service */ "./src/app/core/auth/_services/auth.service.ts");
...
var UserManagementComponent = /** @class */ (function () {
    function UserManagementComponent(appService, schoolService, authService) {
        ...
        this.bulkUserForm = new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormGroup"]({
            numberOfUsers: new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormControl"]('', _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].compose([_angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required])),
            role: new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormControl"]('', _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].compose([_angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required])),
            viewAccess: new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormControl"]('', _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].compose([_angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required])),
    ...
    UserManagementComponent.prototype.createUser = function () {
        ...
        if (this.userForm.invalid) {
            return this.appService.showPopAlertError('Validation failed', 'Please fill all mandatory fields');
        }
        else if (this.userForm.value['password'] !==
            this.userForm.value['confirm-password']) {
            return this.appService.showPopAlertError('Operation failed', 'Password and Confirm Password do not match');
        }
        this.loading = true;
        this.authService
            .createUser(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({}, this.userForm.value, { state: this.userForm.value.states }))
            .subscribe(function (data) {
            _this.loading = false;
            _this.appService.showPopAlertSuccess('Operation successful', 'User created successfully');
            _this.userForm.reset();
            _this.userForm.clearValidators();
            _this.userForm.updateValueAndValidity();
        }, function (error) {
            _this.loading = false;
            _this.loading = false;
            console.log(error);
    ...
    UserManagementComponent.prototype.createBulkUser = function () {
        var _this = this;
        ...
        this.authService
            .bulkUserCreate(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({}, this.bulkUserForm.value, { numberOfUsers: parseInt(this.bulkUserForm.value['numberOfUsers']) }))
            .subscribe(function (data) {
            _this.bulkUserLoading = false;
            _this.appService.showPopAlertSuccess('Operation successful', 'User(s) created successfully');
            _this.bulkUserForm.reset();
            _this.bulkUserForm.clearValidators();
            _this.bulkUserForm.updateValueAndValidity();
        }, function (error) {
            _this.bulkUserLoading = false;
            _this.bulkUserLoading = false;
            console.log(error);
    ...
    UserManagementComponent.ctorParameters = function () { return [
        ...
        { type: _core_auth_services_auth_service__WEBPACK_IMPORTED_MODULE_5__["AuthService"] }
    ]; };
    UserManagementComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_services_app_service_app_service_service__WEBPACK_IMPORTED_MODULE_4__["AppServiceService"],
            ...
            _core_auth_services_auth_service__WEBPACK_IMPORTED_MODULE_5__["AuthService"]])
