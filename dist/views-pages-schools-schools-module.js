...
var SchoolsComponent = /** @class */ (function () {
    function SchoolsComponent(schoolService, changeDetectRef, appService) {
        ...
        this.bulkSchoolCreateForm = new _angular_forms__WEBPACK_IMPORTED_MODULE_5__["FormGroup"]({
            school: new _angular_forms__WEBPACK_IMPORTED_MODULE_5__["FormControl"]('', _angular_forms__WEBPACK_IMPORTED_MODULE_5__["Validators"].compose([])),
        });
    ...
    SchoolsComponent.prototype.ngOnDestroy = function () {
    ...
    SchoolsComponent.prototype.bulkSchoolCreate = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var files, formData;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                try {
                    files = $('#customFile000').prop('files');
                    formData = new FormData();
                    formData.append('schools', files[0]);
                    this.loadingToUpload = true;
                    this.schoolService.bulkCreate(formData).subscribe(function (data) {
                        _this.loadingToUpload = false;
                        window.location.reload();
                    }, function (error) {
                        _this.loadingToUpload = false;
                        _this.appService.showPopAlertError('Operation failed', error.error.message);
                    });
                }
                catch (error) {
                    this.appService.showPopAlertError('Bulk Creation failed', 'some errors were encounred');
                }
                return [2 /*return*/];
            });
        });
